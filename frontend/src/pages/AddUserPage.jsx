...
export default function AddUserPage() {
  ...
  const roleInfo = {
    employee: { label: "Employee", desc: "Can view and update assigned tasks", color: "#22c55e" },
    manager: { label: "Manager", desc: "Can create tasks and manage teams", color: "#f59e0b" },
  };
      ...
      <div style={styles.container}>
        ...
        <div style={styles.layout}>
          ...
          <div style={styles.card}>
            ...
            <div style={styles.section}>
              <p style={styles.sectionTitle}>Role & Permissions</p>
                    ...
                    >
                      <div style={styles.roleTop}>
                        <span style={{
                          ...
                          boxShadow: active ? `0 0 8px ${info.color}` : "none",
                        }} />
                        <span style={{
                        ...
                        {active && (
                          <span style={{ marginLeft: "auto" }}>
                            <svg width="14" height="14" viewBox="0 0 24 24" fill={info.color}>
                              <path d="M20 6L9 17l-5-5" stroke={info.color} strokeWidth="2.5" fill="none" />
                            </svg>
                          </span>
                        )}
                      </div>
                      <p style={styles.roleDesc}>{info.desc}</p>
                    </button>
                  );
                })}
              </div>
            ...
            <div style={styles.footer}>
              ...
              <button onClick={handleSubmit} disabled={loading} style={styles.submitBtn}>
                {loading ? (
                  ...
                  <><svg width="15" height="15" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5"><path d="M16 21v-2a4 4 0 0 0-4-4H5a4 4 0 0 0-4 4v2" /><circle cx="8.5" cy="7" r="4" /><line x1="20" y1="8" x2="20" y2="14" /><line x1="23" y1="11" x2="17" y2="11" /></svg>Add User</>
                )}
              </button>
            </div>
          </div>
...
const styles = {
  ...
  errBanner: {
    ...
    background: "#7f1d1d18", border: "1px solid #ef444430",
    color: "#fca5a5", padding: "11px 14px", borderRadius: 8,
    marginBottom: 20, fontSize: 13,
  },
  section: { marginBottom: 20 },
  sectionTitle: { fontSize: 12, fontWeight: 700, color: "#475569", textTransform: "uppercase", letterSpacing: "0.08em", margin: "0 0 16px" },
  field: { display: "flex", flexDirection: "column", gap: 6, marginBottom: 16 },
  label: { fontSize: 13, fontWeight: 600, color: "#94a3b8" },
  req: { color: "#f87171" },
  input: {
    background: "#0f1117", border: "1px solid #252840",
  ...
  footer: {
    ...
    marginTop: 24, paddingTop: 20, borderTop: "1px solid #1e2540",
  },
  cancelBtn: {
  ...
  sideInfo: {},
  infoCard: {
    background: "#12172a", border: "1px solid #1e2540",
